...
function contactValidation (event) {
    ...
    if (checkValue(teleContact.value, 8)){
        teleContactError.style.display = "none";
    } else {
        teleContactError.style.display = "block";
    }
    ...
    contactResponse.innerHTML = "Thank you for your feedback! It means a lot to us!💚";
